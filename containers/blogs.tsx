  ...
  return (
    <section id="blogs" className="scroll-mt-20">
      ...
      <div className="bg-black px-5 md:px-10 xl:px-0 py-14 pb-20 lg:pt-24 lg:pb-28">
        <div className="flex justify-center items-start container mx-auto">
          {blogs.length > 0 && (
            <div className="flex flex-wrap xl:flex-nowrap justify-center lg:justify-normal gap-6 md:gap-7 w-full">
