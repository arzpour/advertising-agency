...
export const ProjectCardSkeleton = () => {
  return (
    <div className="w-80 rounded-lg overflow-hidden bg-white hover:shadow-2xl cursor-pointer">
      <div className="h-40">
        <div className="h-40 w-full object-cover object-center bg-gray-300 animate-pulse mb-4"></div>
      </div>
      <div className="h-1/2 p-4">
        <div className="flex justify-between items-center">
          <div className="mb-2 font-semibold hover:underline cursor-pointer h-4 w-24 bg-gray-300 animate-pulse rounded-full"></div>
          <p className="text-gray-600 text-xs h-4 w-20 rounded-full bg-gray-300 animate-pulse"></p>
        </div>
        <p className="text-sm font-medium text-gray-700 my-3 line-clamp-2 h-4 w-40 rounded-full bg-gray-300 animate-pulse"></p>
        <div className="flex gap-3 mt-6 mb-2 justify-end items-center">
          <div className="h-4 w-10 rounded-full bg-gray-300 animate-pulse"></div>
          <div className="h-4 w-10 rounded-full bg-gray-300 animate-pulse"></div>
        </div>
      </div>
    </div>
