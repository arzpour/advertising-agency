  ...
  return (
    <div className="flex flex-col justify-between p-4 leading-normal w-full bg-white rounded-lg">
      <div className="flex gap- justify-between items-center">
        <h5 className="mb-2 font-semibold tracking-tight text-gray-900 dark:text-white whitespace-normal break-words">
          {phoneNumber}
        </h5>
      ...
      <p className="text-gray-700 dark:text-gray-400 text-sm mb-1 whitespace-normal break-words">
        {message}
      </p>
    </div>
  );
